...
firstGraph = Label(statisticsFrame, image=test, text="1", width=202, height=20, compound="c", background='#fff700')
firstGraph.place(x=14, y=278)
secondGraph = Label(statisticsFrame, image=test, text="2", width=202, height=20, compound="c", background='#dadada')
secondGraph.place(x=14, y=323)
thirdGraph = Label(statisticsFrame, image=test, text="3", width=202, height=20, compound="c", background='#e08830')
thirdGraph.place(x=14, y=368)
fourthGraph = Label(statisticsFrame, image=test, text="4", width=202, height=20, compound="c", background='#6fc6ff')
fourthGraph.place(x=14, y=413)
fifthGraph = Label(statisticsFrame, image=test, text="5", width=202, height=20, compound="c", background='white')
