...
thridCatagory = Label(statisticsFrame, image=catagory, text="카테고리명", font="나눔스퀘어 10", width=150, height=25, compound="c")
thridCatagory.place(x=283, y=366)
thridSum = Label(statisticsFrame, image=price, text="금액", width=385, height=25, compound="c")
thridSum.place(x=428, y=366)
