...
def incomeWindow() :
    ...
    def incomeInputVal() :
        global dates, money, types, otherDetails
    ...
    incomeLb1.grid(row=0, column=1)
    incomeLb2.grid(row=2, column=1)
    incomeLb3.grid(row=4, column=1)
    incomeLb4.grid(row=6, column=1)
